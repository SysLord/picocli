...
public class CommandLine {
    ...
    public void usage(PrintStream out, Help.ColorScheme colorScheme) {
        out.print(usage(new StringBuilder(), helpFactory().create(getCommandSpec(), colorScheme)));
    }
    ...
    public void usage(PrintWriter writer, Help.ColorScheme colorScheme) {
        writer.print(usage(new StringBuilder(), helpFactory().create(getCommandSpec(), colorScheme)));
    }
    ...
    public String getUsageMessage() {
        return usage(new StringBuilder(), helpFactory().create(getCommandSpec(), Help.defaultColorScheme(Help.Ansi.AUTO))).toString();
    }
    ...
    public String getUsageMessage(Help.Ansi ansi) {
        return usage(new StringBuilder(), helpFactory().create(getCommandSpec(), Help.defaultColorScheme(ansi))).toString();
    }
